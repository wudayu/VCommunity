...
import com.vcommunity.server.modules.utils.UploadUtils;
import com.vcommunity.server.service.AttachmentService;
...
public class UploadFileRestController {
    ...
    public @ResponseBody Message upload(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            String fileId = UploadUtils.uploadFile(request, response);
            message.setMessage("Upload file success, the file id is " + fileId);
