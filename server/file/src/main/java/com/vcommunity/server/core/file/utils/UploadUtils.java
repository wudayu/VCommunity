package com.vcommunity.server.core.file.utils;
...
//    public static PropertiesLoader propertiesLoader = new PropertiesLoader("classpath:application.properties");
    ...
    public List<String> uploadFile(HttpServletRequest request, HttpServletResponse response) throws FileUploadException, IOException {
        ...
        if (isMultipartContent) {
            ...
            for (Iterator<FileItem> iterator=items.iterator(); iterator.hasNext();) {
                ...
                String savePath = filePath + "/" + datePath + "/";
    ...
    public String uploadFile(InputStream inputStream) throws FileUploadException, IOException {
        String fileId = null;
        fileId = getUUID();
    ...
    public byte[] getFileContent2(String path) throws IOException {
